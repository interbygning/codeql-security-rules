...
private import codeql.solidity.ast.Stmt
private import codeql.solidity.controlflow.internal.CFG
private import codeql.solidity.controlflow.BasicBlocks
private import codeql.solidity.controlflow.internal.ConstantExprs
 ...
 */
class ControlFlowNode extends AstNode, ControlFlowNodeBase {
...
// Nota: @cfgnode = @stmt | @expr | @function | @initialiser ;
// Entonces la herencia de esto tiene que incluir esas 4 construcciones
class ControlFlowNodeBase extends AstNode { }
