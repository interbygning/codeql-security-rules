...
class SsaHelper extends int {
   ...
   */
  private predicate ssaDefinitionReachesUseWithinBB(StackVariable v, ControlFlowNode def, Expression use) {
   ...
   */
  private predicate ssaDefinitionReaches(StackVariable v, ControlFlowNode def, Expression use) {
