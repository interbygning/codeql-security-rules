...
import codeql.solidity.controlflow.internal.PrimitiveBasicBlocks
import codeql.solidity.ast.internal.AST
...
class ExitBasicBlock extends BasicBlock {
  ExitBasicBlock() {
    toTreeSitter(this.getEnd()) instanceof Solidity::FunctionBody 
    // or
