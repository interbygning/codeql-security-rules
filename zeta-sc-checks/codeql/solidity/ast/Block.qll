/**
 * Provides a class to model Solidity block statements, enclosed by `{` and `}`.
 */
...
private class TBlock = TBlockStatement or TFunctionBody;

/**
 * A Solidity block statement.
 *
 ...
 * ```
 */
class BlockStmt extends Stmt, TBlock, ControlFlowNodeBase {
  private Solidity::AstNode node;

  BlockStmt(){toTreeSitter(this) = node and 
    (node instanceof Solidity::FunctionBody
  or node instanceof Solidity::BlockStatement) }
