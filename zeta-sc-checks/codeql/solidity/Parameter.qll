 ...
 */
// class Parameter extends LocalScopeVariable, TParameter {
class Parameter extends AstNode, StackVariable {
  private Solidity::Parameter p;

  Parameter(){toTreeSitter(this) = p}
  ...
  //  * own).
  //  */
  // private Variable getAnEffectiveDeclarationEntry() {
  ...
  Function getFunction() {
    exists(Function f | f.getBlock() = this.getParentScope() | result = f)
  }
  ...
  override Location getLocation() {result = p.(Solidity::AstNode).getLocation()}
  // /**
