...
private class Argument extends CallArgument {
  Call call;
  int pos;
 ...
 */
class ArgumentNode extends ArgNode {
  ArgumentNode() {
    this instanceof ArgNode
    // or
  ...
  predicate argumentOf(DataFlowCall call, int pos) {
    exists(Argument a | this.asArgument() = a | call = a.getCall() and pos = a.getPosition())
    // or
...
private class ExprOutNode extends OutNode, ExprNode {
  ExprOutNode() { this.getExpr().getChild(_) instanceof Call }
...
Solidity::PrimitiveType getNodeType(Node n) {
  exists(n) and result = any(Solidity::PrimitiveType t)
  // and
  // // result instanceof VoidType // stub implementation
  // result instanceof Solidity::PrimitiveType; // stub implementation
}

/** Gets a string representation of a type returned by `getNodeType`. */
// string ppReprType(Type t) { none() } // stub implementation
string ppReprType(Solidity::PrimitiveType t) { none() } // stub implementation

/**
 * Holds if `t1` and `t2` are compatible, that is, whether data can flow from
 * a node of type `t1` to a node of type `t2`.
 */
predicate compatibleTypes(Solidity::PrimitiveType t1, Solidity::PrimitiveType t2) {
  // t1 instanceof VoidType and t2 instanceof VoidType // stub implementation
  t1 instanceof Solidity::PrimitiveType and t2 instanceof Solidity::PrimitiveType // stub implementation
}
...
class DataFlowType = Solidity::PrimitiveType;
...
class DataFlowCall extends Call {
   ...
   */
  // override Expr getArgument(int n) { result = super.getArgument(n) }
  override CallArgument getArgument(int n) { result = super.getArgument(n) }

  /** Gets the data flow node corresponding to this call. */
  ExprNode getNode() { result.getExpr() = this.getParent() }
